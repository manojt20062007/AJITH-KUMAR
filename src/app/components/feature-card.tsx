...
export default function FeatureCard({ d, cids, styles }: { d: FeatureCardData; cids: string[]; styles: FeatureCardStyles }) {
  return (
    <div data-cid={cids[0]} className="border-t border-solid border-t-border border-r border-r-border border-b border-b-border border-l-2 border-l-clr-4 block py-10 px-8 rounded-md bg-color-007 transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(255,0,0,0.3)] hover:bg-black/40 hover:backdrop-blur-md hover:border-primary/50 hover:border-l-primary group">
      <div data-cid={cids[1]} className="inline-block mb-4 text-primary text-[1.8125rem] leading-[2.1875rem] transition-transform duration-300 group-hover:scale-110">

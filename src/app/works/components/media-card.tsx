  ...
  return (
    <div data-cid={cids[0]} className="border border-solid border-surface block relative rounded-sm shrink-0 overflow-hidden bg-color-002 shadow-[var(--clr-2)_0px_10px_30px_0px,var(--border)_0px_0px_15px_0px] cursor-pointer group">
      <div data-cid={cids[1]} className="block relative overflow-hidden aspect-[2/3]">
        ...
        {"  "}
        <div data-cid={cids[3]} className="w-95.5 h-[35.8125rem] flex absolute top-0 left-0 z-2 opacity-0 p-6 flex-col justify-end transition-opacity duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:opacity-100" style={{ backgroundImage: "linear-gradient(to top, var(--clr-14) 0%, var(--clr-15) 40%, var(--clr-4) 100%)" }}>
          ...
          {" "}
          <p data-cid={cids[6]} className="block opacity-0 mb-4 text-color-014 text-[0.8125rem] leading-[1.125rem] transform-[matrix(1,0,0,1,0,15)] transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:opacity-100 group-hover:transform-[matrix(1,0,0,1,0,0)]">
            {d.description}
          </p>
          {" "}
          <div data-cid={cids[7]} className="h-[1.3375rem] flex opacity-0 flex-wrap gap-[0.4rem] transform-[matrix(1,0,0,1,0,15)] transition-all duration-700 delay-100 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:opacity-100 group-hover:transform-[matrix(1,0,0,1,0,0)]">
          ...
          {" "}
          <div data-cid={cids[11]} className="h-4 flex opacity-0 mt-4 items-center gap-2 text-primary [font-family:Outfit,_sans-serif] text-[0.8125rem] font-semibold leading-4 tracking-[1.28px] uppercase transform-[matrix(1,0,0,1,0,10)] transition-all duration-700 delay-200 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:opacity-100 group-hover:transform-[matrix(1,0,0,1,0,0)]">
